...
module.exports = async (client, interaction) => {
    ...
    await guild.channels
        .create({
            ...
            parent: "1231333087493755001",
            permissionOverwrites: [
                { id: "1221931396755623947", deny: [PermissionsBitField.Flags.ViewChannel] },
                { id: member.id, allow: [PermissionsBitField.Flags.ViewChannel, PermissionsBitField.Flags.EmbedLinks] },
                { id: "1233427831745417286", allow: [PermissionsBitField.Flags.ViewChannel]}
            ],
        })
        .then(async (channel) => {
